...
from .dataset import NeedleDataset, infer_repo_root, load_training_index, make_test_dataframe
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("outputs/unet_model/test_masks"))
